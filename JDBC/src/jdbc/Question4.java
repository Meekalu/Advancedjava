...
public class Question4 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String query1 = "INSERT INTO stu " + "VALUES (101, 'Priya', 50000, 'CSE')";
			stmt.executeUpdate(query1);
			query1 = "INSERT INTO stu " + "VALUES (102, 'meekalu', 59000, 'IT')";
			stmt.executeUpdate(query1);
			query1 = "INSERT INTO stu " + "VALUES (103, 'sanjana', 50000, 'EEE')";
			stmt.executeUpdate(query1);
			query1 = "INSERT INTO stu " + "VALUES (104, 'Harshi', 42000, 'MECH')";
			stmt.executeUpdate(query1);
